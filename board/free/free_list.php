...
<html>
	<head>
		...
		<link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/todagtodag/board/css/free.css">
	...
	<body>
		...
		<section>
			<div id="board_box">
                    ...
                    <?php
                        ...
                        for ($i = $start; $i < $start + $scale && $i < $total_record; $i++) {
							...
							<li>
								...
								<span class="col2_1"><a
											href="free_view.php?num=<?= $num ?>&page=<?= $page ?>"><?= $subject ?></a></span>
				...
				<ul class="buttons">
					<li>
						<button onclick="location.href='free_list.php'">목록</button>
					</li>
					<li>
