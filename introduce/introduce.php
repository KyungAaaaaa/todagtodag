...
<head>
    ...
    <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/todagtodag/introduce/css/slide.css?ver=5">
    <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/todagtodag/css/common2.css?ver=5">
