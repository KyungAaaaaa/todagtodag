    ...
    switch ($procedure_name) {
      ...
      case 'notice_procedure':
        $sql = "
            ...
            BEGIN
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:02)','12');
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:03)','6');
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:04)','13');
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:05)','36');
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:06)','11');
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:07)','13');
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:08)','19');
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:09)','10');
            INSERT INTO `notice` (`id`,`name`,`subject`,`content`,`regist_day`,`hit`) VALUES ('admin','관리자','제목','내용','2020-10-17 (15:00)','8');
            END";
        break;
      ...
      case 'free_procedure':
        ...
        case 'health_info_procedure':
          $sql = "
              ...
              BEGIN
              INSERT INTO `health_info` (`id`,`subject`,`content`,`category`,`regist_day`,`hit`) VALUES ('admin','수면 이갈이',
              '정의\\n\\n
...
INSERT INTO `health_info` (`id`,`subject`,`content`,`category`,`regist_day`,`hit`) VALUES ('admin','제목',
'내용',
'치과','2020-10-17 (15:00)','8');
INSERT INTO `health_info` (`id`,`subject`,`content`,`category`,`regist_day`,`hit`) VALUES ('admin','제목',
'내용',
