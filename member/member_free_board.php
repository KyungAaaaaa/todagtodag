			...
			<div>
				<ul id="post_list">
                    ...
                    <?php
                        ...
                        $query = "select f.num,count(rp.num) as ripple,f.regist_day,subject,hit from free f left join free_ripple rp  on f.num=rp.parent where f.id='{$row['id']}' group by rp.parent order by f.regist_day desc;";
                        $result = $con->query($query) or die(mysqli_error($con));
                        ...
                        $row = mysqli_fetch_array($result);
							...
							<li>
								...
								<span class="col5">	<input type="hidden" class="review_no" value=<?= $row['num'] ?>><a
