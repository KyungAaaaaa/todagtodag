...
<head>
	<meta charset="utf-8">
	<title>토닥토닥</title>
	<link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/todagtodag/hospital/css/hospital_info.css">
	...
	<section>
		<div class="container">
			...
			<div class="hospital_info">
				<?php
				if (strpos($file_type, "image") !== false) echo "<img src='../data/$file_copied'>";
