        ...
        <div class="hospital_appointment">
            ...
            <div class="hospital_appointment_department">
                ...
                if (!isset($_POST["appointment_department"])) {
                    $_POST["appointment_department"] = "";
                }
                ?>
                <div class="select_option">
                    <p>선택과목 : </p>
                    <input type="text" id="calander_data3" value="<?= $_POST["appointment_department"] ?>" disabled>
                </div>
            </div>
            <div class="hospital_appointment_time">
                ...
                <select size="10">
                    ...
                    $e_operating_time1 = $e_operating_time[1] / 100;
                    ...
                    ?>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                if ($row[0] < 10) {
                                    $str = substr($row[0], 1, 1);
                                    echo "<script>document.getElementById('option{$str}').disabled = true;</script>";
                                    echo "
                                    <script>
                                        var v = document.getElementById('option{$str}').value;
                                        var v2 = v + '0{$str}:00 reserved';
                                        document.getElementById('option{$str}').innerHTML = v2;
                                    </script>
                                    ";
                                }
                            }
